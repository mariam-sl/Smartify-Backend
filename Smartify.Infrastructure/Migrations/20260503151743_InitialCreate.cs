        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Lesson_OrderNumber", "[OrderNumber] > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    PassingScore = table.Column<int>(type: "int", nullable: false, defaultValue: 50),
                    TimeLimit = table.Column<int>(type: "int", nullable: false),
                    IsRetakeAllowed = table.Column<bool>(type: "bit", nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Quizzes", x => x.Id);
                    table.CheckConstraint("CK_Quiz_PassingScore", "[PassingScore] BETWEEN 0 AND 100");
                    table.CheckConstraint("CK_Quiz_TimeLimit", "[TimeLimit] > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Question_OrderNumber", "[OrderNumber] > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttemptDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    DurationSeconds = table.Column<int>(type: "int", nullable: false, defaultValue: 0)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizAttempts", x => x.Id);
                    table.CheckConstraint("CK_QuizAttempt_Duration", "[DurationSeconds] >= 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certificates_GeneratedAt",
                table: "Certificates",
                column: "GeneratedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonCompletions_CompletedAt",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_QuizId_OrderNumber",
                table: "Questions",
                columns: new[] { "QuizId", "OrderNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizAttemptAnswers_QuizAttemptId_QuestionId_SelectedAnswerId",
                table: "QuizAttemptAnswers",
                columns: new[] { "QuizAttemptId", "QuestionId", "SelectedAnswerId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizAttempts_AttemptDate",
                table: "QuizAttempts",
                column: "AttemptDate");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizAttempts_QuizId_AttemptDate",
                table: "QuizAttempts",
                columns: new[] { "QuizId", "AttemptDate" });
